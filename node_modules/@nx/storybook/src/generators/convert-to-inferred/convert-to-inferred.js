...
async function convertToInferred(tree, options) {
    ...
    const migratedProjects = await (0, executor_to_plugin_migrator_1.migrateProjectExecutorsToPluginV1)(tree, projectGraph, '@nx/storybook/plugin', plugin_1.createNodes, {
